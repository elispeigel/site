...
const Style = styled.div`
  display: grid;
  grid-template-columns: ${({ theme }: { theme: ITheme }) =>
    `max(${theme.relationalSizes.horizontal.regular}, calc(${theme.relationalSizes.regular.smaller} * 55px)) auto`};
  grid-column-gap: ${({ theme }: { theme: ITheme }) =>
    theme.relationalSizes.horizontal.small};
